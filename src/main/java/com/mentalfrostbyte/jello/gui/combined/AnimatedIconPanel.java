        ...
        if (!this.method13216() && this.method13214()) {
            ...
            if (this.field20882) {
                if (this.parent == null) {
                    ...
                    if (this.getX() + this.getWidth() > Minecraft.getInstance().getMainWindow().getWidth()) {
                        this.setX(Minecraft.getInstance().getMainWindow().getWidth() - this.getWidth());
                    }
                    ...
                    if (this.getY() + this.getHeight() > Minecraft.getInstance().getMainWindow().getHeight()) {
                        this.setY(Minecraft.getInstance().getMainWindow().getHeight() - this.getHeight());
                    }
                } else {
                    if (this.getX() < 0) {
                        this.setX(0);
