...
public class ProgressBar extends Element {
    ...
    public void draw(float partialTicks) {
        ...
        if (this.method13212() && this.method13298() && var5 != 0.0) {
            int var10 = this.getMouseX() - this.method13271();
        ...
        if (durationLong == 0 && !this.musicManager.isPlayingSong()) {
            ...
            if (var8 != 0.0F) {
                RenderUtil.drawImage((float) this.getX() + (float) this.getWidth() * var8, (float) this.getY(), 5.0F, 5.0F, Resources.shadowRightPNG);
            }
        }
    }
}
