...
public class FakeLag extends Module {
    ...
    public FakeLag() {
        ...
        this.registerSetting(new NumberSetting("Lag duration", "The lags duration", 0.3F, 0.1F, 2.0F, 0.01F));
        this.registerSetting(new NumberSetting("Delay", "The lags cooldown", 0.4F, 0.1F, 2.0F, 0.01F));
