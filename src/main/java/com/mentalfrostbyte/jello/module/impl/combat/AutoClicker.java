...
public class AutoClicker extends Module {
    ...
    public AutoClicker() {
        ...
        this.registerSetting(new NumberSetting("Base CPS", "Base click per seconds.", 1, 1, 20, 1));
        this.registerSetting(new NumberSetting("Min CPS", "Minimum click per seconds randomization.", 1, 1, 20, 1));
        this.registerSetting(new NumberSetting("Max CPS", "Maximum click per seconds randomization.", 1, 1, 20, 1));
        ...
        this.registerSetting(new NumberSetting("Auto Block Ticks", "Autoblock frecuency.", 1, 1, 5, 1));
